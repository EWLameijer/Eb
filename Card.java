...
/** [CC]
 * The Card class represents a card, which has contents (front and back,
...
public class Card implements Serializable {
	...
	// [CCCC] The text/contents of the front of the card
	private String m_textOnFront = null;
	
	// [CCCC] The text/contents of the back of the card
	...
	/** [CPPRCCC]
	 * Creates a new card; ensures that the input is valid. Note that empty 
	 * cards are allowed (after all, a card will be empty before it is filled),
	 * however, an empty card may not be added to a Deck - but that's a matter
	 * of the Deck's policy, of course.
	 * 
	 * @param textOnFront the text to go on the front of the card. May be a 
	 * blank string, but may not be null.
	 * @param textOnBack the text to go on the back of the card. May be a blank 
	 * string, but may not be null.
	 */
