...
public class TimeInterval implements Serializable {
	...
	// The 3.5 in "3.5 hours". Indicates how many of the specified unit go in the
	// duration of this time interval.
	double m_scalar;

	// The "hours" in 3.5 hours. Indicates the unit of time used by this interval.
	TimeUnit m_unit;
	...
	/**
	 * [CPPRCCC] Returns the scalar value of the time interval (the 3.5 in
	 * "3.5 days").
	 * 
